<?php 
    ...
    class AlunoController{
        public function adicionarAluno($nome, $n1, $n2, $n3){
            $resultado = Aluno::adicionarAluno($nome, $n1, $n2, $n3);
        ...
        public function editarAluno($id_aluno){
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                $n2 = $_POST['nota2'];
                $n3 = $_POST['nota3'];
                Aluno::editarAluno($id_aluno, $nome, $n1, $n2, $n3);
                header("Location: index.php?acao=listar");
                exit;
            }
        ...
        public function atualizarJson(){
            ...
            $n2 = $_GET['nota2'];
            $n3 = $_GET['nota3'];
            $resultadoo = Aluno::editarAluno($id_aluno, $nome, $n1, $n2, $n3);
